...
<div class="h4 text-center alert alert-dark mb-4 mt-5" role="alert">รายการการสั่งซื้อ</div>
                                ...
                                <table id="datatablesSimple" table class="table table-hover">
                                    ...
                                    <tbody>
                                    <?php 
                                    $sql="select * from tb_order where id=$ids order by reg_date DESC" ;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
  <?php if ($status == 1) { ?>
    <a href="pay_ment2.php?id=<?=$row["order_id"]?>" class="btn btn-warning" type="submit" onclick="del1(this.href); return false">ชำระเงิน</a>
  <?php } ?>
</td>
<?php } ?>
                                        </tr>
