            ...
            <div id="layoutSidenav_content">
                <main>
                        <div class="card mb-4 mt-4">
                            ...
                            <br>
                            <form name="form1" method="POST" action="report_order.php"><div class="row">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-4">
                                <button type="submit" class="btn btn-outline-success"><i class="fa-solid fa-magnifying-glass" style="color: #0d1ce7;"></i></button>
                                </div> 
                            </div><br></div></form>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" table class="table table-hover">
                                    ...
                                    $ddt1=@$_POST['dt1'];
                                    $ddt2=@$_POST['dt2'];
                                    $add_date=date('Y/n/d', strtotime($ddt2. "+1 days"));
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="pay_order.php?id=<?=$row["order_id"]?>" class="btn btn-warning"type="submit"
                                             onclick="del1(this.href); return false">ปรับสถานะ</a></td>
                                            <td><a href="cancel_order.php?id=<?=$row["order_id"]?>" class="btn btn-danger"type="submit"
